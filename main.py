...
if __name__ == '__main__':
    ...
    model = RAM(usernum, itemnum, args).to(args.device)

    if args.isTrain == 0:
        #the path to save models during testing
        args.saveRoot = 'models_test/'+args.model+'/'+args.dataset+'/'+args.dataset+'_'+str(args.hidden_units)+'_'+str(args.maxlen)+'_'+str(args.num_heads)+'_'+str(args.num_blocks)
